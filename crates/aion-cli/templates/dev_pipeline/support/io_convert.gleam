//// Conversions between the schema-generated wire types
//// (`{{name}}_io`, regenerated by `aion codegen`) and the hand-written
//// domain types in `{{name}}/types`.
////
//// The generated module owns every workflow-level wire shape; the domain
...
//// schema edit that changes a generated type breaks compilation HERE — the
