...
mod tests {
    ...
    /// Package persistence is untouched by the injected append failures:
    /// forward to the wrapped in-memory store.
    #[async_trait::async_trait]
    impl aion_store::PackageStore for FlakyAppendStore {
